...
const Layout: FC<{ children: React.ReactNode, title?: string, meta?: MetaOptions, home?: boolean, style?: React.CSSProperties, className?: string }> = ({ children, title = siteTitle, meta, home, style = { maxWidth: "36rem" }, className = "" }) => {
  return (<>
    <Menu/>
